...
export default function Home() {
  return (
    <main className="flex min-h-screen bg-gradient-to-br from-gray-50 to-[#D2D6DB] items-center justify-center">
      <div className="flex flex-col bg-white p-6 max-w-[340px] max-h-60 gap-4 rounded-lg border-2 border-neutral-200">
